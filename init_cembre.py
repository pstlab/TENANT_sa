...
db.add(c11)
db.commit()
f111 = proc_mod.Function(f_type=cap3, agent=hw)
...
db.add(c121)
db.commit()
f1211 = proc_mod.Function(f_type=cap13, agent=hw)
...
db.add(c12121)
db.commit()
f121211_hw = proc_mod.Function(f_type=cap5, agent=hw)
f121211_ra = proc_mod.Function(f_type=cap5, agent=ra)
...
db.add(c12122)
db.commit()
f121221_hw = proc_mod.Function(f_type=cap7, agent=hw)
f121221_ra = proc_mod.Function(f_type=cap7, agent=ra)
...
db.add(c12123)
db.commit()
f121231_hw = proc_mod.Function(f_type=cap3, agent=hw)
f121231_ra = proc_mod.Function(f_type=cap3, agent=ra)
...
db.add(c12131)
db.commit()
f121311_hw = proc_mod.Function(f_type=cap3, agent=hw)
f121311_ra = proc_mod.Function(f_type=cap3, agent=ra)
...
db.add(c12132)
db.commit()
f121321_hw = proc_mod.Function(f_type=cap6, agent=hw)
f121321_ra = proc_mod.Function(f_type=cap6, agent=ra)
...
db.add(c12133)
db.commit()
f121331_hw = proc_mod.Function(f_type=cap4, agent=hw)
f121331_ra = proc_mod.Function(f_type=cap4, agent=ra)
...
###
f1214 = proc_mod.Function(f_type=cap14, agent=hw)
...
db.add(c122)
db.commit()
f1221 = proc_mod.Function(f_type=cap3, agent=hw)
s1221 = proc_mod.SimpleTask(name='Sposta da 2 a 3', modality='Independent', parent=c122, f=[f1221])
f1222 = proc_mod.Function(f_type=cap13, agent=hw)
...
f1225 = proc_mod.Function(f_type=cap14, agent=hw)
...
db.add(c123)
db.commit()
f1231 = proc_mod.Function(f_type=cap13, agent=hw)
...
f1237 = proc_mod.Function(f_type=cap14, agent=hw)
s1237 = proc_mod.SimpleTask(name='Sblocca', modality='Independent', parent=c123, f=[f1237])

f13 = proc_mod.Function(f_type=cap3, agent=hw)
